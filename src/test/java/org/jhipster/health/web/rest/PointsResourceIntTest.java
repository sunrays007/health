...
public class PointsResourceIntTest {
    ...
    private static final Integer DEFAULT_ALCOLHOL = 1;
    private static final Integer UPDATED_ALCOLHOL = 2;
    ...
    public void createPoints() throws Exception {
        ...
        assertThat(testPoints.getAlcolhol()).isEqualTo(DEFAULT_ALCOLHOL);
    ...
    public void getAllPoints() throws Exception {
        ...
        restPointsMockMvc.perform(get("/api/points?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].alcolhol").value(hasItem(DEFAULT_ALCOLHOL)))
    ...
    public void getPoints() throws Exception {
        ...
        restPointsMockMvc.perform(get("/api/points/{id}", points.getId()))
            ...
            .andExpect(jsonPath("$.alcolhol").value(DEFAULT_ALCOLHOL))
    ...
    public void updatePoints() throws Exception {
        ...
        assertThat(testPoints.getAlcolhol()).isEqualTo(UPDATED_ALCOLHOL);
